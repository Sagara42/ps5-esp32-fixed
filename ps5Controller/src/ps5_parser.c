...
void parsePacket_extended(uint8_t *packet)
{
  ...
  ps5.button.up = directionBtnsOnly == button_mask_up;
  ps5.button.right = directionBtnsOnly == button_mask_right;
  ps5.button.down = directionBtnsOnly == button_mask_down;
  ps5.button.left = directionBtnsOnly == button_mask_left;
  ps5.button.upright = directionBtnsOnly == button_mask_upright;
  ps5.button.upleft = directionBtnsOnly == button_mask_upleft;
  ps5.button.downright = directionBtnsOnly == button_mask_downright;
  ps5.button.downleft = directionBtnsOnly == button_mask_downleft;
  ps5.button.triangle = (frontBtnData & button_mask_triangle) ? true : false;
  ps5.button.circle = (frontBtnData & button_mask_circle) ? true : false;
  ps5.button.cross = (frontBtnData & button_mask_cross) ? true : false;
  ps5.button.square = (frontBtnData & button_mask_square) ? true : false;
  ps5.button.l1 = (extraBtnData & button_mask_l1) ? true : false;
  ps5.button.r1 = (extraBtnData & button_mask_r1) ? true : false;
  ps5.button.l2 = (extraBtnData & button_mask_l2) ? true : false;
  ps5.button.r2 = (extraBtnData & button_mask_r2) ? true : false;
  ps5.button.share = (extraBtnData & button_mask_share) ? true : false;
  ps5.button.options = (extraBtnData & button_mask_options) ? true : false;
  ps5.button.l3 = (extraBtnData & button_mask_l3) ? true : false;
  ps5.button.r3 = (extraBtnData & button_mask_r3) ? true : false;
  ps5.button.ps = (psBtnData & button_mask_ps) ? true : false;
  ps5.button.touchpad = (psBtnData & button_mask_touchpad) ? true : false;

  const uint8_t offset = 128;

  ps5.analog.stick.lx = packet[3] - offset;
  ps5.analog.stick.ly = -packet[4] + offset - 1;
  ps5.analog.stick.rx = packet[5] - offset;
  ps5.analog.stick.ry = -packet[6] + offset - 1;
